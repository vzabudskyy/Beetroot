...
Note that the test opens the file twice;
if you’re feeling ambitious, you may be able to improve this by
passing an open file object into the two count functions (hint: file.seek(0) is a file rewind).
"""
import sys
sys.path.append("C:\\Users\\Vladislav\\PycharmProjects\\BeetrootAcademy\\hw_lesson_8\\")
from mymod import test

name = "test.txt"
chars, lines = test(name)
print(f"{name} {lines} {chars}")
